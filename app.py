...
st.markdown("""
<style>
:root{--navy:#050B1F;--blue:#3B82F6;--blue-light:#60A5FA;--blue-soft:#93C5FD;--gold:#3B82F6;--platinum:#050B1F;--ink:#E2E8F0;--muted:#94A3B8;--line:rgba(59,130,246,.22);--critical:#F87171;--warning:#FBBF24;--stable:#34D399}
.stApp{background:radial-gradient(circle at 78% 8%,rgba(37,99,235,.16),transparent 31%),linear-gradient(160deg,#050B1F 0%,#071426 55%,#050B1F 100%);color:var(--ink)}[data-testid="stHeader"]{background:rgba(5,11,31,.88)}
[data-testid="stSidebar"]{background:rgba(4,10,28,.96);border-right:1px solid rgba(59,130,246,.24)}[data-testid="stSidebar"] *{color:#E8EDF5}
[data-testid="stSidebar"] [data-baseweb="select"]>div,[data-testid="stSidebar"] input,[data-testid="stSidebar"] textarea{background:#0B1733;border-color:rgba(59,130,246,.28)}
.block-container{max-width:1180px;padding-top:2.2rem;padding-bottom:4rem}h1,h2,h3,p,label,.stMarkdown{color:var(--ink)}h1{letter-spacing:-.045em;font-size:2.65rem!important;margin-bottom:.15rem!important;background:linear-gradient(110deg,#FFF 5%,#93C5FD 55%,#3B82F6);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}
.brand{color:#FFF;font-size:1.35rem;font-weight:750;letter-spacing:-.025em}.brand-mark{color:var(--blue-light);padding-right:.45rem}.brand-sub{color:#64748B;font-size:.68rem;letter-spacing:.16em;margin:.1rem 0 1.5rem}.company-line{color:var(--muted);font-size:.92rem;margin-bottom:1.4rem}.live-dot{width:7px;height:7px;display:inline-block;border-radius:50%;background:var(--stable);margin-right:7px;box-shadow:0 0 10px rgba(52,211,153,.7)}.fallback-dot{background:var(--warning)}
.metric-card{background:rgba(59,130,246,.07);border:1px solid var(--line);border-top:3px solid #3B82F6;border-radius:16px;padding:1.25rem 1.4rem;min-height:142px;text-align:center;box-shadow:0 12px 34px rgba(0,0,0,.15);transition:all .22s ease}.metric-card:hover{transform:translateY(-3px);border-color:rgba(96,165,250,.55);box-shadow:0 12px 32px rgba(37,99,235,.14)}.metric-card.alert{border-top-color:var(--critical)}.metric-card.good{border-top-color:var(--stable)}.metric-label{color:#A8B5C7;font-size:.7rem;font-weight:700;letter-spacing:.1em;text-transform:uppercase}.metric-value{color:#F8FAFC;font-size:2.25rem;line-height:1.2;font-weight:800;margin:.45rem 0 .25rem}.metric-note{color:#B1BDCC;font-size:.8rem}.section-label{color:#60A5FA;font-size:.7rem;font-weight:800;letter-spacing:.13em;text-transform:uppercase;margin:1.8rem 0 .6rem}
.action-bar{display:flex;align-items:center;gap:.75rem;min-height:44px}.freshness{color:#B7C2D1;font-size:.82rem;line-height:1.45}.freshness strong{color:#F8FAFC}.overview-note{background:rgba(52,211,153,.09);border:1px solid rgba(52,211,153,.22);border-radius:12px;padding:.8rem 1rem;color:#C7F9E4;font-size:.87rem;margin:.9rem 0 1.1rem}.overview-note.attention{background:rgba(251,191,36,.08);border-color:rgba(251,191,36,.24);color:#FDE68A}.signal-summary{display:grid;grid-template-columns:repeat(3,1fr);gap:.7rem;margin:.85rem 0 1.1rem}.signal-item{background:rgba(11,23,51,.72);border:1px solid var(--line);border-radius:12px;padding:.85rem 1rem}.signal-number{color:#F8FAFC;font-size:1.35rem;font-weight:850}.signal-label{color:#B1BDCC;font-size:.75rem;margin-top:.15rem}.empty-panel{background:rgba(52,211,153,.1);border:1px solid rgba(52,211,153,.2);border-radius:14px;padding:1.15rem;color:#C7F9E4;min-height:110px;display:flex;align-items:center}.registry-help{color:#B1BDCC;font-size:.82rem;margin-bottom:.75rem}
.chart-heading{color:#F8FAFC;font-size:.96rem;font-weight:800;margin:.2rem 0 .65rem}.chart-sub{color:var(--muted);font-size:.78rem;margin-top:-.5rem;margin-bottom:.35rem}
.summary-card{position:relative;overflow:hidden;background:linear-gradient(135deg,rgba(37,99,235,.2),rgba(59,130,246,.07));border:1px solid rgba(96,165,250,.35);border-radius:18px;padding:1.4rem 1.5rem;margin:1.15rem 0 1.5rem;box-shadow:0 15px 35px rgba(0,0,0,.16)}.summary-card:after{content:"";position:absolute;width:180px;height:180px;border-radius:50%;right:-65px;top:-90px;background:radial-gradient(circle,rgba(96,165,250,.2),transparent 68%);pointer-events:none}.summary-top{display:flex;align-items:center;justify-content:space-between;gap:1rem;margin-bottom:1rem}.summary-title{color:#F8FAFC;font-size:1.12rem;font-weight:850}.summary-sub{color:#93C5FD;font-size:.76rem;margin-top:.18rem}.summary-status{padding:.34rem .68rem;border-radius:999px;font-size:.67rem;font-weight:850;letter-spacing:.07em;white-space:nowrap}.summary-status.critical{color:#FCA5A5;background:rgba(248,113,113,.13);border:1px solid rgba(248,113,113,.3)}.summary-status.medium{color:#FCD34D;background:rgba(251,191,36,.11);border:1px solid rgba(251,191,36,.28)}.summary-status.stable{color:#6EE7B7;background:rgba(52,211,153,.11);border:1px solid rgba(52,211,153,.28)}.audit-zone{position:relative;background:rgba(2,6,23,.25);border:1px solid rgba(148,163,184,.1);border-radius:12px;padding:1rem 1.05rem;margin-top:.8rem}.audit-zone-title{color:#60A5FA;font-size:.69rem;font-weight:850;letter-spacing:.1em;text-transform:uppercase;margin-bottom:.55rem}.audit-text{color:#CBD5E1;font-size:.87rem;line-height:1.7}.audit-text strong{color:#FFF}.audit-list{margin:.15rem 0 0;padding-left:1.08rem;color:#CBD5E1;font-size:.87rem;line-height:1.72}.audit-list strong{color:#FFF}.priority-zone{border-left:3px solid #3B82F6;background:linear-gradient(90deg,rgba(37,99,235,.18),rgba(2,6,23,.18))}.quick-steps{display:grid;grid-template-columns:repeat(3,1fr);gap:.7rem;margin-top:.55rem}.quick-step{background:rgba(15,23,42,.52);border:1px solid rgba(96,165,250,.14);border-radius:10px;padding:.8rem}.step-time{color:#60A5FA;font-size:.66rem;font-weight:850;letter-spacing:.08em;text-transform:uppercase;margin-bottom:.35rem}.step-text{color:#CBD5E1;font-size:.82rem;line-height:1.58}.step-text strong{color:#FFF}@media(max-width:800px){.quick-steps{grid-template-columns:1fr}.summary-top{align-items:flex-start}.summary-status{white-space:normal}}
.task-card{background:rgba(11,23,51,.8);border:1px solid var(--line);border-left:5px solid var(--stable);border-radius:16px;margin:1rem 0 .45rem;padding:1.3rem 1.45rem;box-shadow:0 12px 30px rgba(0,0,0,.18);transition:all .18s ease}.task-card:hover{transform:translateY(-2px);border-color:rgba(96,165,250,.38)}.task-card.critical{border-left-color:var(--critical)}.task-card.medium{border-left-color:var(--warning)}.task-card.stable{border-left-color:var(--stable)}.task-top{display:flex;align-items:flex-start;justify-content:space-between;gap:1rem}.task-title{color:#F8FAFC;font-weight:800;font-size:1.08rem}.task-meta{color:var(--muted);font-size:.79rem;margin-top:.22rem}.risk-badge{border-radius:999px;padding:.3rem .62rem;font-size:.66rem;font-weight:850;letter-spacing:.07em;white-space:nowrap}.critical .risk-badge{color:#FCA5A5;background:rgba(248,113,113,.13)}.medium .risk-badge{color:#FCD34D;background:rgba(251,191,36,.12)}.stable .risk-badge{color:#6EE7B7;background:rgba(52,211,153,.12)}.problem{color:#E2E8F0;font-size:.95rem;font-weight:650;margin:1rem 0 .55rem}.quote{color:#94A3B8;background:rgba(0,0,0,.19);border-left:2px solid #334155;padding:.7rem .9rem;font-style:italic;border-radius:0 6px 6px 0}.resolution{color:#E2E8F0;background:linear-gradient(135deg,rgba(37,99,235,.16),rgba(59,130,246,.05));border:1px solid rgba(59,130,246,.2);border-left:3px solid var(--blue);padding:.9rem 1rem;margin-top:.9rem;border-radius:0 9px 9px 0}.resolution-title{color:#60A5FA;font-size:.72rem;font-weight:850;letter-spacing:.07em;margin-bottom:.32rem}.human-status{color:#64748B;font-size:.77rem;margin:.25rem 0 .55rem}
[data-testid="stTabs"] [data-baseweb="tab-list"]{gap:1rem;border-bottom:1px solid var(--line)}[data-testid="stTabs"] button{color:#94A3B8;font-weight:650;padding-left:.35rem;padding-right:.35rem}[data-testid="stTabs"] button[aria-selected="true"]{color:#F8FAFC}[data-testid="stTabs"] [data-baseweb="tab-highlight"]{background-color:var(--blue)}[data-testid="stDataFrame"]{border:1px solid var(--line);border-radius:14px;overflow:hidden}div[data-testid="stPlotlyChart"]{background:rgba(11,23,51,.68);border:1px solid var(--line);border-radius:16px;padding:.45rem;box-shadow:0 12px 30px rgba(0,0,0,.14)}
[data-testid="stMain"] .stButton>button{min-height:2.6rem;border-radius:9px!important;font-weight:750!important;background:#FFF!important;color:#0F172A!important;border:1px solid #CBD5E1!important;box-shadow:0 3px 10px rgba(15,23,42,.05)!important}[data-testid="stMain"] .stButton>button:hover{border-color:#C5A880!important;color:#806B4D!important;background:#FFFCF7!important}[data-testid="stMain"] .stButton>button[kind="primary"]{background:#0F172A!important;color:#FFF!important;border-color:#0F172A!important}[data-testid="stMain"] .stButton>button[kind="primary"]:hover{background:#1E293B!important;color:#FFF!important;border-color:#C5A880!important}[data-testid="stMain"] .stButton>button:disabled{opacity:.48!important}
...
def _sentiment_chart(data: pd.DataFrame) -> go.Figure:
    ...
    fig = go.Figure(go.Pie(
        ...
        marker=dict(colors=[colors[key] for key in counts.index], line=dict(color="#0B1733", width=3)),
        textinfo="percent", textfont=dict(size=12, color="#FFFFFF"),
        hovertemplate="%{label}: %{value} отзывов<extra></extra>",
    ))
    fig.add_annotation(text=f"<b>{int(counts.sum())}</b><br><span style='font-size:11px'>отзывов</span>", showarrow=False, font=dict(size=22, color="#F8FAFC"))
    fig.update_layout(height=310, margin=dict(l=8, r=8, t=12, b=8), paper_bgcolor="rgba(0,0,0,0)",
                      legend=dict(orientation="h", y=-.05, x=.5, xanchor="center", font=dict(color="#94A3B8")))
    return fig
...
def _issues_chart(data: pd.DataFrame) -> go.Figure:
    ...
    fig = go.Figure(go.Bar(
        x=counts.values, y=counts.index, orientation="h", marker=dict(color="#3B82F6", cornerradius=6),
    ...
    fig.update_yaxes(showgrid=False, title=None, tickfont=dict(size=12, color="#CBD5E1"))
    return fig
